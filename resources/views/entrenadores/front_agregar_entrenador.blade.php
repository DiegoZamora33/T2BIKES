    ...
    <form action="/entrenadores" method="post">
        ...
        <div class="Dato">
         ...
         <div class="Dato">
            ...
            <input type="text" name="patrocinio" id="patrocinio" pattern="^[a-zA-ZñÑáéíóú.\s]{0,50}$" title="El nombre solo pose letras, acentos, puntos y espacios (Maximo 50 caracteres)" required>    
        </div class="Dato">
